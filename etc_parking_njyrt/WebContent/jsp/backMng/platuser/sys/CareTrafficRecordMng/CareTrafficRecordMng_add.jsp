     ...
     <div class="modal-body">
		<form class="form-horizontal">
             <div class="box-body">
					...
					<label for="traffic_date" class="col-sm-3 control-label">traffic_date<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="park_id" class="col-sm-3 control-label">park_id<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="area_id" class="col-sm-3 control-label">area_id<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="lane_id" class="col-sm-3 control-label">lane_id<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="lane_flag" class="col-sm-3 control-label">lane_flag<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="care_traffic" class="col-sm-3 control-label">care_traffic<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="pay_method" class="col-sm-3 control-label">pay_method<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="member_type" class="col-sm-3 control-label">member_type<oak:required></oak:required></label>
					<div class="col-sm-9">
...
datetime<oak:required></oak:required></label>
				...
				<div class="form-group">
					<label for="comment" class="col-sm-3 control-label">comment<oak:required></oak:required></label>
					<div class="col-sm-9">
