...
<!-- 								<option value="1">大车</option> -->
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input id="begin_time" name="begin_time" value="${bean.begin_time}" type="text" 
							class="form-control" placeholder="请输入每日生效时间" reqMsg="请输入每日生效时间" 
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input id="end_time" name="end_time" value="${bean.end_time}" type="text" 
							class="form-control" placeholder="请输入每日失效时间" reqMsg="请输入每日失效时间" 
							autocomplete="off" onfocus="WdatePicker({dateFmt:'HH:mm'})" />
					 </div>
               </div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input id="period" name="period" value="${bean.period}" type="number" 
							...
							autocomplete="off" reqMsg="请输入停车时长"/>
					 </div>
               </div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input id="free_time" name="free_time" value="${bean.free_time}" type="number" 
							...
							autocomplete="off" reqMsg="请输入免费时长"/>
					 </div>
               </div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input id="money_limit" name="money_limit" value="${bean.money_limit}" type="number" 
							...
							autocomplete="off" reqMsg="请输入上限金额"/>
					 </div>
               </div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input id="s_comment" name="s_comment" value="${bean.s_comment}" type="text" class="form-control" placeholder="请输入备注" autocomplete="off"/>
					 </div>
               </div>
