					...
					<div class="col-sm-12 ">
						<table class="queryTable">
							<tr>
								<td>姓名</td>
								<td>
									<input type="text" id="QUERY_NAME" value="${queryParam.NAME}" placeholder="" autocomplete="off">
								</td>
						...
						<tbody>
							<c:forEach items="${list }" var="obj" varStatus="status">
								<tr>
									...
									<td>${obj.MOBILE}</td>
									<td>
										${obj.IN_USE_FLAG==1?'启用':'禁用' }
									</td>
									<td>${obj.CREATE_TIME}</td>
									<td>
										<ul class="list-inline">
											<li title="查看"><a href="javascript:tool.dialog('view.shtml?ID=${obj.ID }')"><i class="fa fa-file-text-o text-blue"></i><span class="text-blue"></span>查看</a></li>
											<li title="修改"><a href="javascript:tool.dialog('edit.shtml?ID=${obj.ID }')"><i class="fa fa-pencil-square-o text-green"></i><span class="text-green"></span>修改</a></li>
											<li title="删除"><a href="javascript:deleteData('${obj.ID }')"><i class="fa fa-trash-o text-red"></i> <span class="text-red"></span>删除</a></li>
										</ul>
									</td>
								</tr>
							</c:forEach>
