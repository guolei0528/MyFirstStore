...
<!-- 									<td><select id="dis_free" name="dis_free"
									...
									<td>收费员编号</td> 
									<td>
									<input type="text" id="query_terminaloperator" name=query_terminaloperator value="${queryParam.query_terminaloperator}" placeholder="" autocomplete="off">
									</td>
									<td>
...
<%-- 										<td>${obj.exitdate}</td> --%> 
										...
										<td>
											<%-- 										${obj.terminaltime} --%> <fmt:formatDate
												pattern="yyyy-MM-dd  HH:mm:ss" value="${obj.terminaltime}" />
										</td>
										<td>
											...
											<c:set var="interval"
												value="${obj.terminaltime.time - obj.entrytime.time}" /> <c:if
