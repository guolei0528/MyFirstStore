						...
						<div class="col-sm-12 ">
							<table class="queryTable">
								...
								<tr>
									...
									<td>-</td>
									<td><input type="text" id="query_end_date"
										name="query_exit_end_date" onfocus="WdatePicker()"
										value="${queryParam.query_exit_end_date}"></td>
									<td>
								</tr>
							</table>
										...
										<td>
											...
											<c:set var="interval"
												...
												<fmt:formatNumber value="${interval/1000/60/60%24 -0.5}"
													pattern="#0" />小时
												</c:if> <fmt:formatNumber value="${interval/1000/60%60 -0.5}" pattern="#0" />分 <fmt:formatNumber
