					...
					<div class="col-xs-22">
						<div class="box">
							<div class="box-header">
								<h3 class="box-title" style='float:left;'>入口流水报表</h3>
										...
										<thead>
											<tr>
											   ...
											   <th colspan="1" rowspan="2">车道</th>
												...
												<th colspan="2">车牌（次）</th>
												<th colspan="4">ETC（次）</th>
												<th colspan="1">人工（次）</th>
												<th colspan="1">总流量（次）</th>
												<th colspan="3">运营情况</th>
											</tr>
											<tr align="center">
												<td colspan="1">有车牌</td>
												<td colspan="1">无车牌</td>
