											...
											<c:forEach items="${detail }" var="obj" varStatus="status">
												<tr>
													...
													<td><a href=""><fmt:formatNumber type="percent"
																maxIntegerDigits="3"
																value="${(obj.entry_flow_total+obj.exit_flow_total) == 0 ? 1:(obj.entry_flow_total+obj.exit_flow_total-obj.special_license_recognition)/(obj.entry_flow_total+obj.exit_flow_total)}" />
													</a></td>
													<td><a href="">${obj.special_server_restart}次</a></td>
													<td><a href="">${obj.special_not_found}次</a></td>
													<td><a href="">${obj.special_exception_charge}辆</a></td>
													<td><a href="">${obj.special_over_time}辆</a></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
