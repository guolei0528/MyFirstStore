     ...
     <div class="modal-body">
		<form class="form-horizontal">
             <div class="box-body">
					...
					<label for="recordno" class="col-sm-3 control-label">recordno<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="cardnetwork" class="col-sm-3 control-label"> cardnetwork<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="cardid" class="col-sm-3 control-label"> cardid<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="parkid" class="col-sm-3 control-label"> parkid<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="areaid" class="col-sm-3 control-label"> areaid<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="entrystation" class="col-sm-3 control-label"> entrystation<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="entrylane" class="col-sm-3 control-label"> entrylane<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="entrytime" class="col-sm-3 control-label"> entrytime<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="entryoperator" class="col-sm-3 control-label"> entryoperator<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="entryshift" class="col-sm-3 control-label"> entryshift<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="autovlicense" class="col-sm-3 control-label"> autovlicense<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="mvlicense" class="col-sm-3 control-label"> mvlicense<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="imagepath" class="col-sm-3 control-label">imagepath<oak:required></oak:required></label>
					<div class="col-sm-9">
