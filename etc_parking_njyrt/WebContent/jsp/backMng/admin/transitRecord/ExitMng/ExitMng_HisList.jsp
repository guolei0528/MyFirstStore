			...
			<div class="container" style="width: 100%">
				...
				<div class="box mt10">
					<div class="box-header">
						<div class="col-sm-6">历史出口流量检索</div>
						<div class="col-sm-6"></div>
						<div class="col-sm-12 ">
							<table class="queryTable">
								<tr>
									<td>车牌号</td>
									<td><input type="text" id="query_mvlicense"
										name="query_mvlicense" value="${queryParam.query_mvlicense}"
										placeholder="" autocomplete="off"></td>
									<td>出口车道号</td>
									<td><input type="text" name="query_lane_id"
										value="${queryParam.query_lane_id }"></td>
									<td>历史时间</td>
									<td><input
										onfocus="WdatePicker({ dateFmt: 'yyyy-MM', isShowToday: false, isShowClear: false })"
										name="last_date" value="${queryParam.last_date }"></td>
...
<%-- 										<td>${obj.entrystation}</td> --%>
										...
										<td>
											<ul class="list-inline">
											 	<li title="查看"><a
													href="javascript:tool.dialog('viewHis.shtml?exittime=${fn:replace(obj.exittime," ", ",")}
													&mvlicense=${obj.mvlicense }&exitlane=${obj.exitlane }
													&tableName=${queryParam.tableName }')"><i
														class="fa fa-file-text-o text-blue"></i><span
														class="text-blue"></span>查看</a></li>
<!-- 												<li title="查看图片"><a class="btn btn-primary" -->
<!-- 													data-toggle="modal" type="button" -->
<!-- 													data-target=".bs-example-modal-lg" onclick="explore(this)" -->
<%-- 													dktp="/img/${obj.exitlane}/${obj.exitdate}/${obj.imagepath}"><i --%>
<!-- 														class="fa fa-file-text-o text-blue"></i><span -->
<!-- 														class="text-blue"></span>查看图片</a></li> -->
											</ul>
										</td>
									</tr>
								</c:forEach>
