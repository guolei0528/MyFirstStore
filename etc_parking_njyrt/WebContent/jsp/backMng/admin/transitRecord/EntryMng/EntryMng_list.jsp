...
<%-- 									<td>${obj.entryshift}</td> --%>
									...
									<ul class="list-inline"> 
								    	<li title="查看"><a href="javascript:tool.dialog('view.shtml?entrytime=${fn:replace(obj.entrytime," ", ",")}&entrylane=${obj.entrylane }&mvlicense=${obj.mvlicense }')"><i class="fa fa-file-text-o text-blue"></i><span class="text-blue"></span>查看</a></li> 
