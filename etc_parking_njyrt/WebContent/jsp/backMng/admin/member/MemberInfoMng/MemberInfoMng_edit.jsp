		...
		<form class="form-horizontal">
             <div class="box-body">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input id="memberId" name="memberId" value="${bean.memberId}" type="text"  disabled="disabled"
             ...
             <div class="box-body">
			  ...
			  <div class="form-group">
					<label for="MOBILE" class="col-sm-3 control-label"> 出生日期<oak:required></oak:required></label>
					<div class="col-sm-9">
						<input id="birthday" name="birthday" value="${bean.birthday}" type="date" 
							class="form-control" placeholder="请输入出生日期" reqMsg="请输入出生日期" 
							autocomplete="off"/>
					 </div>
               </div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input id="location" name="location" value="${bean.phone}" type="text" 
