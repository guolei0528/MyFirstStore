		...
		<form class="form-horizontal">
             <div class="box-body">
			   ...
			   <div class="row">
					...
					<div class="col-md-2 text-right"><p> 发行张数</p></div>
					<div class="col-md-4 text-left">
						${bean.issue_count}
					</div>
               </div>
               ...
               <div class="row">
               	...
               	<div class="row">
					<div class="col-md-2 text-right"><p> 开始时间</p></div>
					<div class="col-md-4 text-left">
						<fmt:formatDate value="${bean.start_time}" pattern="yyyy-MM-dd HH:mm:ss" />
					</div>
					<div class="col-md-2 text-right"><p> 结束时间</p></div>
					<div class="col-md-4 text-left">
					<fmt:formatDate value="${bean.end_time}" pattern="yyyy-MM-dd HH:mm:ss" />
					</div>
               </div>
               
               <div class="row">
					<div class="col-md-2 text-right"><p> 使用张数</p></div>
					<div class="col-md-4 text-left">
						${bean.use_count }
					</div>
					<div class="col-md-2 text-right"><p> 剩余张数</p></div>
					<div class="col-md-4 text-left">
						${bean.remain_count }
					</div>
               </div>
               ...
               <div class="row">
					<div class="col-md-2 text-right"><p> 作废张数</p></div>
					<div class="col-md-4 text-left">
						${bean.invalid_count }
					</div>
