     ...
     <div class="modal-body">
		<form class="form-horizontal">
             <div class="box-body">
					...
					<label for="card_type" class="col-sm-3 control-label">卡类别<oak:required></oak:required></label>
					<div class="col-sm-9">
						<input id="card_type" name="card_type" value="${bean.card_type}" type="text" 
							...
							autocomplete="off"/>
							<select id="card_type" class="form-control" reqMsg="请选择卡类型">
								<option></option>
								<option></option>
							</select>
					 </div>
				...
				<div class="form-group">
					<label for="card_network" class="col-sm-3 control-label">卡网络编号<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="card_id" class="col-sm-3 control-label">card_id<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="card_status" class="col-sm-3 control-label">card_status<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="status_type" class="col-sm-3 control-label">status_type<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="issuer_id" class="col-sm-3 control-label">issuer_id<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="electronic_id" class="col-sm-3 control-label">electronic_id<oak:required></oak:required></label>
					<div class="col-sm-9">
...
mv_license<oak:required></oak:required></label>
				...
				<div class="form-group">
					<label for="mv_license_colour" class="col-sm-3 control-label">mv_license_colour<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="intime" class="col-sm-3 control-label">intime<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="cancel_time" class="col-sm-3 control-label">cancel_time<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="issuer_version" class="col-sm-3 control-label">issuer_version<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="ban_type" class="col-sm-3 control-label">ban_type<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="issuer_effective_time" class="col-sm-3 control-label">
issuer_effective_time<oak:required></oak:required></label>
				...
				<div class="form-group">
					<label for="valid_flag" class="col-sm-3 control-label">valid_flag<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="valid_time" class="col-sm-3 control-label">valid_time<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="lock_card" class="col-sm-3 control-label">lock_card<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="contact_info" class="col-sm-3 control-label">contact_info<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="s_comment" class="col-sm-3 control-label">s_comment<oak:required></oak:required></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label for="version" class="col-sm-3 control-label">version
